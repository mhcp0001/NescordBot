...
class TestConfigManager:
    ...
    def setup_method(self):
        ...
        test_vars = [
            ...
            "MAX_AUDIO_SIZE_MB", "SPEECH_LANGUAGE", "DATABASE_URL",
            "GITHUB_TOKEN", "GITHUB_REPO", "OBSIDIAN_VAULT_PATH"
        ]
    ...
    def test_config_manager_with_env_file(self):
        ...
        with tempfile.NamedTemporaryFile(mode='w', suffix='.env', delete=False) as f:
            f.write("DISCORD_TOKEN=MTA1234567890123456.GH7890.abcdefghijklmnop123456789012345678901234\n")
