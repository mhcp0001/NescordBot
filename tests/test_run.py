...
from run import BotRunner, main
...
class TestBotRunner:
    ...
    def setup_method(self):
        ...
        os.environ["DISCORD_TOKEN"] = "MTA1234567890123456.GH7890.abcdefghijklmnop123456789012345678901234"
    ...
    def teardown_method(self):
        ...
        test_vars = [
            "DISCORD_TOKEN", "OPENAI_API_KEY", "LOG_LEVEL",
            "MAX_AUDIO_SIZE_MB", "SPEECH_LANGUAGE"
        ]
    ...
    def test_setup_logging_failure(self):
        ...
        with patch('run.get_logger', side_effect=Exception("Logging error")), \
    ...
    async def test_start_success(self):
        ...
        with patch.object(runner, 'validate_environment', return_value=True), \
...
class TestRunnerIntegration:
    ...
    def test_environment_masking(self):
        ...
        assert "MTA1234567890123456.GH7890.abcdefghijklmnop123456789012345678901234" not in log_output
